...
<div>
  ...
  <div v-else>
    ...
    <div v-if="returnItem.extension === 'folder'">
      <hr>
      <el-upload class="upload-demo" name="files" :action="getUploadAction()" :limit="uploadLimit" :on-exceed="handleExceed" :on-error="handleError" :on-success="handleSuccess" :file-list="fileList">
...
import deItemComments from './deItemComments.vue'
