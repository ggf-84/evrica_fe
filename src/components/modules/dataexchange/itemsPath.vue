...
<!-- end store parent path -->
    ...
    <hr>
    <el-button type="info" icon="el-icon-plus" @click="dialogVisible = true">Create</el-button>
    <el-upload class="upload-demo" v-if="getSelectedParent.extension === 'folder' || getSelectedParent.parent_id === null" name="files" :action="getUploadAction()" :limit="uploadLimit" :show-file-list="false" :on-exceed="handleExceed" :on-error="handleError" :on-success="handleSuccess" :file-list="fileList">
